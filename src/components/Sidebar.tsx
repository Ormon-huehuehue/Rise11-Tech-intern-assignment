...
const SideBar= () => {
  ...
  return (
    <div className=" flex flex-col w-[300px] h-[calc(100vh-105px)] font-montserrat font-semibold justify-between">
      <ul className=" flex flex-col justify-center items-center mt-[5vh] text-sidebarText">
        <li className="w-full py-4 pl-8 cursor-pointer text-gray-500 hover:bg-gray-100 text-lg flex gap-4">
      ...
      <div className="flex justify-center py-5  rounded-lg">
        <img src={image} width={230} className="rounded-lg"/>
      </div>
    </div>
  );
};
